    ...
    return (
        ...
        <Slider {...settings}>
            <div className="col-lg-3">
                <div className="single_product only">
                    <div className="product_thumb">
                        <Link className="primary_img" href="product-details.html"><img src="/img/product/product15.jpg" alt="" /></Link>
                        <Link className="secondary_img" href="product-details.html"><img src="/img/product/product16.jpg" alt="" /></Link>
                    ...
                    <div className="product_content">
                        <h3><Link href="product-details.html">Marshall Portable  Bluetooth</Link></h3>
            ...
            <div className="col-lg-3">
                <div className="single_product only">
                    <div className="product_thumb">
                        <Link className="primary_img" href="product-details.html"><img src="/img/product/product17.jpg" alt="" /></Link>
                        <Link className="secondary_img" href="product-details.html"><img src="/img/product/product18.jpg" alt="" /></Link>
                        <div className="product_action">
                            <div className="hover_action">
                                <Link href="#"><FaPlus /></Link>
                                <div className="action_button">
            ...
            <div className="col-lg-3">
                <div className="single_product only">
                    <div className="product_thumb">
                        <Link className="primary_img" href="product-details.html"><img src="/img/product/product19.jpg" alt="" /></Link>
                        <Link className="secondary_img" href="product-details.html"><img src="/img/product/product20.jpg" alt="" /></Link>
                        <div className="product_action">
                            <div className="hover_action">
                                <Link href="#"><FaPlus /></Link>
                                <div className="action_button">
